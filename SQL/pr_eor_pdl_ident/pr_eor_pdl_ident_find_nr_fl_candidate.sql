...
-- =============================================================================
-- Функция поиска кандидатов НР ФЛ
-- =============================================================================
CREATE OR REPLACE FUNCTION eor.pr_eor_pdl_ident_find_nr_fl_candidate(
    p_full_name        TEXT,
    p_birth_date       DATE
)
RETURNS INTEGER
...
BEGIN
    ...
    INSERT INTO tmp_eor_ident_candidate (
        find_candidate_id,
        etalon_registry_id,
        eor_h_id,
        weight
    ...
    SELECT p_find_id,
      ...
      FROM (
            SELECT m.etalon_registry_id,
              ...
              JOIN idwh2.idwh2_etalon_nr_fl f ON f.etalon_registry_id = m.etalon_registry_id
